...
!(function(e, t) {
  ...
  var p = (function(n) {
    ...
    try {
      _.apply((t = M.call(k.childNodes)), k.childNodes),
        ...
        if (h.qsa && (!b || !b.test(e))) {
          if (
            ...
            for (
              ...
              u[l] = f + he(u[l]);
            (d = (ee.test(e) && de(t.parentNode)) || t), (p = u.join(","));
          }
          if (p)
            try {
              return _.apply(n, d.querySelectorAll(p)), n;
            } catch (e) {
            } finally {
      ...
      return l !== T && 9 === l.nodeType && l.documentElement
        ? ((i = (T = l).documentElement),
          ...
          h.getById
            ...
            : (delete x.find.ID,
              (x.filter.ID = function(e) {
                ...
                return function(e) {
                  var t =
                    typeof e.getAttributeNode !== L && e.getAttributeNode("id");
                  return t && t.value === n;
                };
              })),
          ...
          (x.find.CLASS =
            h.getElementsByClassName &&
            function(e, t) {
              if (typeof t.getElementsByClassName !== L && y)
    ...
    (re.attr = function(e, t) {
      ...
      var n = x.attrHandle[t.toLowerCase()],
        r = n && D.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !y) : void 0;
      return void 0 !== r
        ? r
        : h.attributes || !y
        ? e.getAttribute(t)
    ...
    function ye(p, h, m, g, v, e) {
      return (
        ...
        oe(function(e, t, n, r) {
          ...
          } else (d = ve(d === t ? d.splice(u, d.length) : d)), v ? v(null, t, d, r) : _.apply(t, d);
        })
      );
    }
    function be(e) {
    ...
    return (
      ...
      (g = re.select = function(e, t, n, r) {
        ...
        return (
          (u || d(e, c))(r, t, !y, n, (ee.test(e) && de(t.parentNode)) || t), n
        );
      }),
      (h.sortStable =
        N.split("")
  ...
  function ze() {
    ...
    (t = N.getElementsByTagName("body")[0]) &&
      ...
      (Be = !0),
      h.getComputedStyle &&
        ((Me = "1%" !== (h.getComputedStyle(e, null) || {}).top),
        (Oe =
        ...
        (e.style.width = "1px"),
        (Be = !parseFloat((h.getComputedStyle(r, null) || {}).marginRight))),
      (e.innerHTML = "<table><tr><td></td><td>t</td></tr></table>"),
      ((r = e.getElementsByTagName("td"))[0].style.cssText =
        "margin:0;border:0;padding:0;display:none"),
      (Fe = 0 === r[0].offsetHeight) &&
        ((r[0].style.display = ""),
  ...
  h.getComputedStyle
    ...
    ((He = N.createElement("div")).innerHTML =
      "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"),
    (qe = (_e = He.getElementsByTagName("a")[0]) && _e.style) &&
      ((qe.cssText = "float:left;opacity:.5"),
      (v.opacity = "0.5" === qe.opacity),
      (v.cssFloat = !!qe.cssFloat),
      (He.style.backgroundClip = "content-box"),
      (He.cloneNode(!0).style.backgroundClip = ""),
      (v.clearCloneStyle = "content-box" === He.style.backgroundClip),
      (v.boxSizing =
        "" === qe.boxSizing ||
        "" === qe.MozBoxSizing ||
        "" === qe.WebkitBoxSizing),
      C.extend(v, {
        reliableHiddenOffsets: function() {
          return null == Fe && ze(), Fe;
        },
        boxSizingReliable: function() {
          return null == Oe && ze(), Oe;
        },
        pixelPosition: function() {
          return null == Me && ze(), Me;
        },
        reliableMarginRight: function() {
          return null == Be && ze(), Be;
        }
      })),
  ...
  function Ke(e, t) {
    if (t in e) return t;
    for (
      var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = Qe.length;
      i--;
  ...
  function nt(e, t, n) {
    ...
    if (i <= 0 || null == i) {
      if (
        (((i = De(e, t, o)) < 0 || null == i) && (i = e.style[t]), Re.test(i))
      )
        return i;
  ...
  C.extend({
    ...
    style: function(e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          ((t = C.cssProps[s] || (C.cssProps[s] = Ke(l, s))),
    ...
    css: function(e, t, n, r) {
      var i,
        ...
        s = C.camelCase(t);
      return (
        (t = C.cssProps[s] || (C.cssProps[s] = Ke(e.style, s))),
        (a = C.cssHooks[t] || C.cssHooks[s]) &&
          "get" in a &&
          (o = a.get(e, !0, n)),
        void 0 === o && (o = De(e, t, r)),
    ...
    C.each(["height", "width"], function(e, i) {
      C.cssHooks[i] = {
        get: function(e, t, n) {
          if (t)
            return Ue.test(C.css(e, "display")) && 0 === e.offsetWidth
              ? C.swap(e, Ye, function() {
                  return nt(e, i, n);
                })
              : nt(e, i, n);
        },
      ...
      (C.cssHooks.opacity = {
        ...
        set: function(e, t) {
          ...
          (((n.zoom = 1) <= t || "" === t) &&
            ...
            (n.filter = Ie.test(o) ? o.replace(Ie, i) : o + " " + i);
        }
      }),
    (C.cssHooks.marginRight = $e(v.reliableMarginRight, function(e, t) {
      if (t)
    ...
    C.each({ margin: "", padding: "", border: "Width" }, function(i, o) {
      (C.cssHooks[i + o] = {
        ...
        Pe.test(i) || (C.cssHooks[i + o].set = et);
    }),
    C.fn.extend({
      css: function(e, t) {
        return X(
        ...
        1 === t.nodeType &&
          ...
          "inline" ===
            ("none" === (u = C.css(t, "display"))
              ? C._data(t, "olddisplay") || je(t.nodeName)
              : u) &&
            "none" === C.css(t, "float") &&
  ...
  function yt(e, t, n) {
    for (
      var r, i = (mt[t] || []).concat(mt["*"]), o = 0, a = i.length;
      o < a;
      o++
    )
  ...
  function bt(o, e, t) {
    ...
    for (
      ...
      if ((n = ht[r].call(u, o, c, u.opts))) return n;
    return (
      C.map(c, yt, u),
  ...
  (C.Animation = C.extend(bt, {
    ...
    (C.fx.tick = function() {
      var e,
        t = C.timers,
        n = 0;
      for (it = C.now(); n < t.length; n++)
        (e = t[n])() || t[n] !== e || t.splice(n--, 1);
      t.length || C.fx.stop(), (it = void 0);
    }),
    ...
    (C.fx.interval = 13),
    (C.fx.start = function() {
      ot = ot || setInterval(C.fx.tick, C.fx.interval);
    }),
    (C.fx.stop = function() {
    ...
    (st = N.createElement("div")).setAttribute("className", "t"),
    (st.innerHTML =
      "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"),
    (ut = st.getElementsByTagName("a")[0]),
    (ct = (lt = N.createElement("select")).appendChild(
      N.createElement("option")
    )),
    (at = st.getElementsByTagName("input")[0]),
    (ut.style.cssText = "top:1px"),
    (v.getSetAttribute = "t" !== st.className),
    ...
    (lt.disabled = !0),
    (v.optDisabled = !ct.disabled),
    (at = N.createElement("input")).setAttribute("value", ""),
    (v.input = "" === at.getAttribute("value")),
    (at.value = "t"),
    at.setAttribute("type", "radio"),
  ...
  C.fn.extend({
      ...
      attr: function(e, t, n) {
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return typeof e.getAttribute === M
            ...
            : ((1 === o && C.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (r = C.attrHooks[t] || (C.expr.match.bool.test(t) ? Tt : wt))),
              void 0 === n
      ...
      set: function(e, t, n) {
        return (
          !1 === t
            ? C.removeAttr(e, n)
            : (Et && kt) || !Nt.test(n)
            ? e.setAttribute((!kt && C.propFix[n]) || n, n)
    ...
    (Et && kt) ||
      (C.attrHooks.value = {
        set: function(e, t, n) {
          if (!C.nodeName(e, "input")) return wt && wt.set(e, t, n);
          e.defaultValue = t;
        }
      }),
    kt ||
  ...
  C.fn.extend({
      ...
      if (u)
        for (e = (t || "").match(L) || []; s < l; s++)
          if (
            (r =
              1 === (n = this[s]).nodeType &&
              (n.className ? (" " + n.className + " ").replace(jt, " ") : " "))
          ) {
            for (o = 0; (i = e[o++]); )
              r.indexOf(" " + i + " ") < 0 && (r += i + " ");
    ...
    hasClass: function(e) {
      for (var t = " " + e + " ", n = 0, r = this.length; n < r; n++)
        if (
          1 === this[n].nodeType &&
          0 <= (" " + this[n].className + " ").replace(jt, " ").indexOf(t)
        )
          return !0;
      return !1;
    }
  ...
  (qt = Rt.exec(_t.toLowerCase()) || []),
    C.extend({
      ...
      ajax: function(e, t) {
        ...
        var n,
          ...
          T = {
            ...
            getResponseHeader: function(e) {
              ...
              if (2 === w) {
                if (!i)
                  for (i = {}; (t = Ft.exec(f)); ) i[t[1].toLowerCase()] = t[2];
                t = i[e.toLowerCase()];
              }
        ...
        m.hasContent ||
          (m.data &&
            ((c = m.url += (Dt.test(c) ? "&" : "?") + m.data), delete m.data),
          !1 === m.cache &&
            (m.url = Ot.test(c)
              ? c.replace(Ot, "$1_=" + Lt++)
              : c + (Dt.test(c) ? "&" : "?") + "_=" + Lt++)),
  ...
  (C.offset = {
    ...
    C.each(["top", "left"], function(e, n) {
      C.cssHooks[n] = $e(v.pixelPosition, function(e, t) {
        if (t)
          return (t = De(e, n)), Re.test(t) ? C(e).position()[n] + "px" : t;
      });
    }),
  ...
  return (
    (C.noConflict = function(e) {
      return h.$ === C && (h.$ = cn), e && h.jQuery === C && (h.jQuery = un), C;
    }),
